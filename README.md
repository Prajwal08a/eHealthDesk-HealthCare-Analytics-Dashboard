...
![Hospital Summary](./screenshots/Hosiptal%20Sumary%20.png)

### 2. Patients Summary

![Patient Summary](./screenshots/Patient%20Summary%20.png)
...
1. Clone the repository:
   ```bash
   git clone https://github.com/your-username/ehealthdesk-dashboard.git
   ```
